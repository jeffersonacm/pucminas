...
namespace Exercicio06
{
    class Program
    {
        ...
        public static Administrador cadastrarAdministrador()
        {
            ...
            Console.Write("Identidade.............: "); administrador.Identidade = Console.ReadLine();
        ...
        public static Professor cadastrarProfessor()
        {
            ...
            professor.Admissao = Console.ReadLine();
            Console.Write("Nascimento.............: ");
            professor.Nascimento = Console.ReadLine();
            Console.Write("Nome do Pai............: ");
            professor.NomePai = Console.ReadLine();
            Console.Write("Nome da Mãe............: ");
            professor.NomeMae = Console.ReadLine();
            Console.Write("Identidade.............: ");
            professor.Identidade = Console.ReadLine();
            Console.Write("CPF....................: ");
            professor.Cpf = Console.ReadLine();
            Console.Write("Carteira de Trabalhado.: ");
            professor.CarteiraTrabalhador = Console.ReadLine();
            Console.Write("Horas Aula.............: ");
            professor.HorasAula = Convert.ToInt32(Console.ReadLine());
            Console.Write("Aulas Semanais.........: ");
            professor.AulasSemanais = Convert.ToInt32(Console.ReadLine());
            Console.Write("Titulação..............: ");
            professor.Titulacao = Console.ReadLine();
        ...
        public static void listarFuncionarios(Funcionario[] funcionarios)
        {
            foreach (Funcionario funcionario in funcionarios)
            {
                if (funcionario is Administrador)
                {
                    ...
                    Console.WriteLine("Nome: {0}", administrador.Nome);
                    Console.WriteLine("Endereço: {0}", administrador.Endereco);
                    Console.WriteLine("Email: {0}", administrador.Email);
                    Console.WriteLine("Admissão: {0}", administrador.Admissao);
                    Console.WriteLine("Nascimento: {0}", administrador.Nascimento);
                    Console.WriteLine("Nome do Pai: {0}", administrador.NomePai);
                    Console.WriteLine("Nome da Mãe: {0}", administrador.NomeMae);
                    Console.WriteLine("Identidade: {0}", administrador.Identidade);
                    Console.WriteLine("Carteira de Trabalho: {0}", administrador.CarteiraTrabalhador);
                    Console.WriteLine("Cargo: {0}", administrador.Cargo);
                    Console.WriteLine("Setor: {0}", administrador.Setor);
                }
